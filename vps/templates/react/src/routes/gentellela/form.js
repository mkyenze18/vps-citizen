        ...
        <div className="">
                        ...
                        <div className="x_title">
                            ...
                            <ul className="nav navbar-right panel_toolbox">
                                ...
                                <li className="dropdown">
                                    <a href="#" className="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i className="fa fa-wrench"></i></a>
                        ...
                        <div className="x_content">
                            ...
                            <form id="demo-form2" data-parsley-validate className="form-horizontal form-label-left">
                                ...
                                <div className="item form-group">
                                    ...
                                    <div className="col-md-6 col-sm-6 ">
                                        <input id="birthday" className="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required="required" onFocus={handleChangeToDate} onMouseOver={handleChangeToDate} onClick={handleChangeToDate} onBlur={handleChangeToText} onMouseOut={timeFunctionLong}/>
                                    </div>
                                </div>
                    ...
                    <div className="x_panel">
                        <div className="x_title">
                            ...
                            <ul className="nav navbar-right panel_toolbox">
                                ...
                                <li className="dropdown">
                                    <a href="#" className="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i className="fa fa-wrench"></i></a>
                        ...
                        <div className="x_content">
                            ...
                            <form className="form-label-left input_mask">
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-9 col-sm-9 ">
                                        <input className="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required="required" onFocus={handleChangeToDate} onMouseOver={handleChangeToDate} onClick={handleChangeToDate} onBlur={handleChangeToText} onMouseOut={timeFunctionLong}/>
                                    </div>
                                </div>
                                <div className="ln_solid"></div>
                                <div className="form-group row">
                    ...
                    <div className="x_panel">
                        ...
                        <div className="x_content">
                            ...
                            <form id="demo-form" data-parsley-validate>
                                ...
                                <p>
                                    M:
                                    <input type="radio" className="flat" name="gender" id="genderM" value="M" defaultChecked="" required /> F:
                        ...
                        <div className="x_content">
                            ...
                            <form className="form-horizontal form-label-left">
                                ...
                                <div className="control-group row">
                                    ...
                                    <div className="col-md-9 col-sm-9 ">
                                        <input id="tags_1" type="text" className="tags form-control" defaultValue="social, adverts, sales" />
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-9 col-sm-9 ">
                                        ...
                                        <div className="radio">
                                            <label>
                                                <input type="radio" defaultChecked="" value="option1" id="optionsRadios1" name="optionsRadios"/> Option one. only select one option
                                            </label>
                                        </div>
                                        <div className="radio">
                                            <label>
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-9 col-sm-9 ">
                                        <div className="checkbox">
                                            <label>
                                                <input type="checkbox" className="flat" defaultChecked="checked"/> Checked
                                            </label>
                                        </div>
                                        <div className="checkbox">
                                            <label>
                                        ...
                                        <div className="checkbox">
                                            <label>
                                                <input type="checkbox" className="flat" disabled="disabled" defaultChecked="checked"/> Disabled & checked
                                            </label>
                                        </div>
                                        <div className="radio">
                                            <label>
                                                <input type="radio" className="flat" defaultChecked name="iCheck"/> Checked
                                            </label>
                                        </div>
                                        <div className="radio">
                                            <label>
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-9 col-sm-9 ">
                                        <div className="">
                                            <label>
                                                <input type="checkbox" className="js-switch" defaultChecked /> Checked
                                            </label>
                                        </div>
                                        <div className="">
                                            <label>
                                        ...
                                        <div className="">
                                            <label>
                                                <input type="checkbox" className="js-switch" disabled="disabled" defaultChecked="checked" /> Disabled Checked
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="dropdown input-group row">
                                            ...
                                            <div className="input-group-btn">
                                                ...
                                                <ul className="dropdown-menu dropdown-menu-right" role="menu">
                                                    ...
                                                    <li><a className="dropdown-item" href="#">Separated link</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            {/* <!-- /btn-group --> */}
            ...
            <div className="x_panel">
                ...
                <div className="x_content">
                    ...
                    <form className="form-horizontal form-label-left">
                        <div className="form-group row">
                            <label className="control-label col-md-3" htmlFor="first-name">First Name <span className="required">*</span>
                            </label>
                        ...
                        <div className="form-group row">
                            <label className="control-label col-md-3" htmlFor="last-name">Last Name <span className="required">*</span>
                            </label>
                            <div className="col-md-7">
