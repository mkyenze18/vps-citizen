...
export default function Police_Stations() {
    ...
    <div className="">
      <div className="page-title">
        <div className="title_left">
          <h3>Police Stations <small>Police Stations in the system</small></h3>
        </div>
        ...
        <div className="col-md-6 col-sm-6  ">
          <div className="x_panel">
            {/* <div className="x_title">
              <h2>Police Stations <small>Police Stations in the system</small></h2>
