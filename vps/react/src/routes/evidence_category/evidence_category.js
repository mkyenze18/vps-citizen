...
export default function Evidence_Category(props) {
  ...
  function getResource(id) {
    axios.get(`${url}/vps/api/v0/evidence-categories/${id}`)
  ...
  function postResource(data) {
    ...
    axios.post(`${url}/vps/api/v0/evidence-categories`, data, config)
    .then(function (response) {
      // handle success
      console.log(response);
      const result = response.data
      ...
      toast.success("Evidence Category posted successfully", {
  ...
  function putResource(id, data) {
    ...
    axios.put(`${url}/vps/api/v0/evidence-categories/${id}`, data, config)
    .then(function (response) {
      // handle success
      console.log(response);
      setIsLoaded(true);
      ...
      // TODO https://fkhadra.github.io/react-toastify/positioning-toast
      toast.success("Evidence Category updated successfully", {
        position: toast.POSITION.TOP_RIGHT
      });
    })
    .catch(function(error){
  ...
  function deleteResource() {
    ...
    axios.delete(`${url}/vps/api/v0/evidence-categories/${id}`, config)
    .then(function (response) {
      // handle success
      console.log(response);
      setIsLoaded(true);
      ...
      // TODO https://fkhadra.github.io/react-toastify/positioning-toast
      toast.warning("Evidence Category deleted successfully", {
        position: toast.POSITION.TOP_RIGHT
      });
  ...
  return (
    <div className="col-md-6 ">
        ...
        <MyVerticallyCenteredModal
          ...
          heading="Delete evidence category" // TODO https://stackoverflow.com/questions/39523040/concatenating-variables-and-strings-in-react
          title="Are you sure?"
