...
import IPRSPersonModal from '../../components/modal_iprs_person';
import OccurrenceDetail from './occurrence_detail';
...
export default function Resource(props) {
  ...
  const [resourcesRank, setResourcesRank] = useState([]);
  ...
  const serviceNumberInput = useRef(null);
  const emailInput = useRef(null);
  const mobilePhoneInput = useRef(null);
  const rankInput = useRef(null);
  const policeStationInput = useRef(null);

  const inputRefsArray = [idIPRS_PersonInput,
    serviceNumberInput,
    emailInput, mobilePhoneInput,
    rankInput, policeStationInput
]
  ...
  let PoliceOfficerClassName = 'col-sm-12';
  if (params.resourceId) {
      PoliceOfficerClassName += ' col-md-8';
  }
  ...
  function getResource(id) {
    ...
    .then(function (response) {
        ...
        // getResourceIPRS_Person(result["iprs_person"]);
        setSelectedResourceIPRS_person(result["iprs_person"])
        populateIPRS_PersonForm(result["iprs_person"]);

        idInput.current.value = result["id"];
        serviceNumberInput.current.value = result["service_number"];
        emailInput.current.value = result["email_address"];
        mobilePhoneInput.current.value = result["mobile_phone"];
        rankInput.current.value = result["rank"]["id"];
  ...
  function postResource(data) {
    ...
    .then(function (response) {
      ...
      // TODO https://fkhadra.github.io/react-toastify/positioning-toast
      toast.success("Police Officer posted successfully", {
  ...
  function putResource(id, data) {
    axios.put(`${url}/vps/api/v0/police-officers/${id}`, data)
    .then(function (response) {
      // handle success
      console.log(response);
      setIsLoaded(true);
  ...
  function deleteResource() {
    ...
    .then(function (response) {
      ...
      // TODO https://fkhadra.github.io/react-toastify/positioning-toast
      toast.warning("Police Officer deleted successfully", {
        position: toast.POSITION.TOP_RIGHT
      });
    })
    .catch(function(error){
  ...
  function resetMugShot() {
    ...
    axios.put(`${url}/vps/api/v0/police-officers/${id}/reset-mug`)
      .then(function (response) {
        // handle success
        console.log(response);
        setIsLoaded(true);
  ...
  function initDropzone() {
    ...
    Dropzone.options.uploadForm = { // The camelized version of the ID of the form element
      ...
      url: `${url}/vps/api/v0/police-officers/${params.resourceId}`,
  ...
  function resetForm() {
    ...
    rankInput.current.value = "";
    policeStationInput.current.value = "";
            ...
            <div id="wizard" className="form_wizard wizard_horizontal">
              ...
              <div id="step-1">
                ...
                <div className="row">
                  <div className={IPRS_PersonClassName}>
                      ...
                      <div className="x_content">
                          ...
                          <div className="row">
                              ...
                              <div className="field col-md-5 col-sm-12  form-group">
                              ...
                              <div className="field col-md-2 col-sm-12  form-group mt-auto">
                                <button type="button" className="btn btn-primary btn-block mb-0" ref={searchButton} onClick={() => handleSearch()} disabled={!isLoaded}>
                                  {!isLoaded &&
                  ...
                  <div className={PoliceOfficerClassName}>
                    <div className="x_panel">
                      {/* <div className="x_title">
                          <h2>Form Design <small>different form elements</small></h2>
                          <ul className="nav navbar-right panel_toolbox">
                      ...
                      <div className="x_content">
                          ...
                          <fieldset disabled={!isLoadedIPRS_Person}>
                            <div className="row">
                                <div className="field col-md-4 col-sm-12 pull-right form-group">
                                    <label>System ID</label>
                                ...
                                <div className="field col-md-4 col-sm-12 pull-right form-group">
                                    ...
                                    <input type="text" placeholder="Service number" className="form-control" ref={serviceNumberInput} name="service_number" />
                                </div>
                            </div>
                            ...
                            <div className="row">
                                ...
                                <div className="field col-md-6 col-sm-12  form-group">
                                    <label>Rank<span className="required">*</span></label>
                                    {/* <input type="number" placeholder="Nationality" className="form-control" ref={nationalityInput} name="nationality" required="required" /> */}
                                    <select className="form-control" ref={rankInput} name="rank" required="required" >
                                      <option value="">Select rank</option>
                                      {resourcesRank.map(item => (
                                          <option key={item.id} value={item.id}>{item.name}</option>
                                      ))}
                                    </select>
                                </div>
                          ...
                          <div className="d-flex p-2 bd-highlight">
                            ...
                            <div className="">
                              <button type="button" className="btn btn-primary" ref={cancelButton} onClick={() => {resetForm()}} disabled={!isLoaded || !isLoadedIPRS_Person}>Cancel</button>
                              <button type="submit" className="btn btn-success" ref={submitButton} disabled={!isLoaded || !isLoadedIPRS_Person}>
                                  {!isLoaded &&
                                  <span className="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                  }
                                  Submit
                  ...
                  <MyVerticallyCenteredModal
                      ...
                      heading="Reset Police Officer mug shot"
                      title="Are you sure?"
                      body="This action cannot be undone."
                      isloading={!isLoaded}
                      />
                    ...
                    <div className="x_content">
                        ...
                        <div className="row justify-content-end">
                          <div className="field col-md-4 col-sm-12  form-group">
                              ...
                              {/* <input type="number" placeholder="Nationality" className="form-control" ref={nationalityInput} name="nationality" required="required" /> */}
                              <select className="form-control" ref={nationalityInput} name="occurrence_category" onChange={(e) => handleOccurrenceDetailSelect(e)} >
                          ...
                          <div className="field col-md-1 col-sm-12  form-group d-flex justify-content-end align-items-end">
                            <button type="submit" className="btn btn-success" disabled={!selectedResourceOccurrenceCategory}>Add</button>
                          </div>
                        </div>
                        
                        {OccurrenceDetail(selectedResourceOccurrenceCategory)}
