...
export default function Resource(props) {
  ...
  // REST ACTIIONS
  function getResourcesUsers() {
    axios.get(`${url}/vps/api/v0/users`)
    .then(function (response) {
      // handle success
      console.log(response);
      setIsLoaded(true);
      setResourcesUser(response.data.results);
    })
  ...
  function getResource(id) {
    ...
    .then(function (response) {
        ...
        userInput.current.value = result.user?.id ? result.user?.id : '';
            ...
            <div className="x_content">
                ...
                <fieldset disabled={!isLoadedIPRS_Person}>
                  <div className="row">
                      ...
                      <div className="field col-md-4 col-sm-12  form-group">
                        <label>System User<span className="required">*</span></label>
                        {/* <input type="number" placeholder="Gender" className="form-control" ref={genderInput} name="gender" required="required" /> */}
                        <select className="form-control" ref={userInput} name="user" >
                          <option value="">Select user</option>
                          {resourcesUser.map(item => (
