...
export default function Police_Station(props) {
  ...
  const inputRefsArray = [nameInput, countryInput, locationInput]
  ...
  function getResource(id) {
    axios.get(`${url}/vps/api/v0/police-stations/${id}`)
    .then(function (response) {
      // handle success
      console.log(response);
      ...
      countryInput.current.value = result["country"]
  ...
  function postResource(data) {
    ...
    .then(function (response) {
      ...
      toast.success("Police Station posted successfully", {
  ...
  function deleteResource() {
    ...
    .then(function (response) {
      ...
      // TODO https://fkhadra.github.io/react-toastify/positioning-toast
      toast.warning("Police Station deleted successfully", {
        position: toast.POSITION.TOP_RIGHT
      });
  ...
  return (
    <div className="col-md-6 ">
        <div className="x_panel">
          ...
          <div className="x_content">
            ...
            <form className="form-label-left input_mask" ref={resourceForm} onSubmit={handleSubmit} noValidate>
              ...
              <div className="field item form-group">
                <label className="col-form-label col-md-3 col-sm-3 ">Country<span className="required">*</span></label>
                {/* <input type="number" placeholder="Nationality" className="form-control" ref={nationalityInput} name="nationality" required="required" /> */}
                <div className="col-md-9 col-sm-9 ">
                  <select className="form-control" ref={countryInput} name="country" required="required">
              ...
              <div className="field item form-group">
                <label className="col-form-label col-md-3 col-sm-3 ">Location</label>
                <div className="col-md-9 col-sm-9 ">
                  <input type="text" className="form-control" placeholder="location" ref={locationInput} required="required"/>
                </div>
              </div>
        ...
        <MyVerticallyCenteredModal
          ...
          heading="Delete Police Station" // TODO https://stackoverflow.com/questions/39523040/concatenating-variables-and-strings-in-react
          title="Are you sure?"
