...
export default function Rank(props) {
  ...
  function postResource(data) {
    ...
    .then(function (response) {
      ...
      toast.success("Rank posted successfully", {
  ...
  function putResource(id, data) {
    ...
    axios.put(`${url}/vps/api/v0/ranks/${id}`, data, config)
    .then(function (response) {
      // handle success
      console.log(response);
      setIsLoaded(true);
  ...
  function deleteResource() {
    ...
    .then(function (response) {
      ...
      // TODO https://fkhadra.github.io/react-toastify/positioning-toast
      toast.warning("Rank deleted successfully", {
        position: toast.POSITION.TOP_RIGHT
      });
  ...
  return (
    <div className="col-md-6 ">
          ...
          <div className="x_content">
            ...
            <form className="form-label-left input_mask" ref={resourceForm} onSubmit={handleSubmit} noValidate>
              ...
              <div className="field item form-group">
                ...
                <div className="col-md-9 col-sm-9 ">
                  <input type="text" className="form-control" placeholder="name" ref={nameInput} name="name" required="required"/>
                </div>
              </div>
        ...
        <MyVerticallyCenteredModal
          ...
          heading="Delete rank" // TODO https://stackoverflow.com/questions/39523040/concatenating-variables-and-strings-in-react
          title="Are you sure?"
