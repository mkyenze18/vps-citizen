...
export default function Evidence_Category(props) {
  ...
  const inputRefsArray = [nameInput, makeInput, modelInput, unitInput]
  ...
  function getResource(id) {
    axios.get(`${url}/vps/api/v0/evidence-item-categories/${id}`)
    .then(function (response) {
      ...
      modelInput.current.value = result["model"]
  ...
  function postResource(data) {
    ...
    axios.post(`${url}/vps/api/v0/evidence-item-categories`, data, config)
    .then(function (response) {
      // handle success
      console.log(response);
      const result = response.data
      ...
      toast.success("Evidence Item Category posted successfully", {
  ...
  function putResource(id, data) {
    ...
    axios.put(`${url}/vps/api/v0/evidence-item-categories/${id}`, data, config)
    .then(function (response) {
      // handle success
      console.log(response);
      setIsLoaded(true);
      ...
      // TODO https://fkhadra.github.io/react-toastify/positioning-toast
      toast.success("Evidence Item Category updated successfully", {
        position: toast.POSITION.TOP_RIGHT
      });
    })
    .catch(function(error){
  ...
  function deleteResource() {
    ...
    axios.delete(`${url}/vps/api/v0/evidence-item-categories/${id}`, config)
    .then(function (response) {
      // handle success
      console.log(response);
      setIsLoaded(true);
      ...
      // TODO https://fkhadra.github.io/react-toastify/positioning-toast
      toast.warning("Evidence Item Category deleted successfully", {
        position: toast.POSITION.TOP_RIGHT
      });
  ...
  return (
    <div className="col-md-6 ">
          ...
          <div className="x_content">
            ...
            <form className="form-label-left input_mask" ref={resourceForm} onSubmit={handleSubmit} noValidate>
              ...
              <div className="field item form-group">
                ...
                <div className="col-md-9 col-sm-9 ">
                  <input type="text" className="form-control" placeholder="name" ref={nameInput} required="required" name="name" />
                </div>
              </div>

              <div className="field item form-group">
                <label className="col-form-label col-md-3 col-sm-3 ">Make</label>
                <div className="col-md-9 col-sm-9 ">
                  <input type="text" className="form-control" placeholder="make" ref={makeInput} name="make" />
                </div>
              </div>

              <div className="field item form-group">
                <label className="col-form-label col-md-3 col-sm-3 ">Model</label>
                <div className="col-md-9 col-sm-9 ">
                  <input type="text" className="form-control" placeholder="model" ref={modelInput} name="model" />
                </div>
              </div>

              <div className="field item form-group">
                <label className="col-form-label col-md-3 col-sm-3 ">Unit</label>
                <div className="col-md-9 col-sm-9 ">
                  <input type="text" className="form-control" placeholder="unit" ref={unitInput} name="unit" />
                </div>
              </div>
        ...
        <MyVerticallyCenteredModal
          ...
          heading="Delete evidence Item category" // TODO https://stackoverflow.com/questions/39523040/concatenating-variables-and-strings-in-react
          title="Are you sure?"
