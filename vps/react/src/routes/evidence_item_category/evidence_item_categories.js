...
export default function Evidence_Categories() {
    ...
    <div className="">
      <div className="page-title">
        <div className="title_left">
          <h3>Evidence Item Categories <small>Evidence Item Categories in the system</small></h3>
        </div>
        ...
        <div className="col-md-6 col-sm-6  ">
          <div className="x_panel">
            {/* <div className="x_title">
              <h2>Evidence Item Categories <small>Evidence Item Categories in the system</small></h2>
