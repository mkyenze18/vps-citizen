...
.then(function (response) {
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (parking_session.cost == null){
          parking_session.cost= 0
        }
        ...
        switch (day) {
          case "mon":
            mon_total += parking_session.cost
            break;
          case "tue":
            tue_total += parking_session.cost
            break;
          case "wed":
            wed_total += parking_session.cost
            break;
          case "thu":
            thu_total += parking_session.cost
            break;
          case "fri":
            fri_total += parking_session.cost
            break;
          case "sat":
            sat_total += parking_session.cost
            break;
          case "sun":
            sun_total += parking_session.cost
            break;
          default:
            break;
        }

        // total += array[index].cost;
...
function initChart(total) {
  var ctx = document.getElementById("myAreaChart");
  var session_by_dayChart = new Chart(ctx, {
    type: 'line',
    data: {
